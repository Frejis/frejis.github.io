...
Eight things from cryptography and programming languages that are usually explained
...
Windows, so the quoted glob is what the READMEs use throughout. 145 tests pass
